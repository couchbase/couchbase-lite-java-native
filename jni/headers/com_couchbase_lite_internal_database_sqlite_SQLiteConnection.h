...
#include <jni.h>
/* Header for class com_couchbase_lite_internal_database_sqlite_SQLiteConnection */

#ifndef _Included_com_couchbase_lite_internal_database_sqlite_SQLiteConnection
#define _Included_com_couchbase_lite_internal_database_sqlite_SQLiteConnection
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_couchbase_lite_internal_database_sqlite_SQLiteConnection
 * Method:    nativeOpen
