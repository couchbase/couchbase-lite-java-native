...
#include <jni.h>
/* Header for class com_couchbase_lite_internal_database_sqlite_SQLiteQueryCursor */

#ifndef _Included_com_couchbase_lite_internal_database_sqlite_SQLiteQueryCursor
#define _Included_com_couchbase_lite_internal_database_sqlite_SQLiteQueryCursor
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     com_couchbase_lite_internal_database_sqlite_SQLiteQueryCursor
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_com_couchbase_lite_internal_database_sqlite_SQLiteQueryCursor_nativeIsAfterLast
  (JNIEnv *, jclass, jlong);
