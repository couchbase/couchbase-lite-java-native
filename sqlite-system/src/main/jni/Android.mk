...
### libsqlite shared library ###
include $(CLEAR_VARS)
LIBSQLITE_PATH := ../../../../vendor/sqlite/libs
LOCAL_MODULE := libsqlite
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/$(LIBSQLITE_PATH)/../src/headers
LOCAL_SRC_FILES := $(LIBSQLITE_PATH)/android/$(TARGET_ARCH_ABI)/libsqlite.so
include $(PREBUILT_SHARED_LIBRARY)

### Build CBLJavaSQLiteShared ###
include $(CLEAR_VARS)
LOCAL_MODULE := CBLJavaNativeSQLiteSystem
